...
public class OperateEx {
    public static void main(String[] args) {
        ...
        // = : 대입연산자 : 생성한 변수에 값을 넣는 것을 대입이라고 함.
        int num3 = 10;
        ...
        int num4 = 10;
//       System.out.println(++num4); //  피연산자의 뒤에 붙은 경우 후위증강연산자로 동작, 선 대입 후 증가
...
//        System.out.println(x <= y); // true
        ...
        rst1 = (x > 0 && x > y); // false, && 둘다 참이여야 참
        rst2 = (x > 0 || x > y); // true, 둘중 하나만 참이여도 참
        rst3 = !((x > 0 || x > y)); //false, 괄호 내의 결과값을 반전시킴
...
//        int age = sc.nextInt();
//     // boolean isAdult = (age > 19) ? true : false; // 조건식이 참이면 ? 뒤의 코드 실행, 아니면 : 뒤의 코드 실행
//     // System.out.println(isAdult);
//        String adult = (age > 19) ? "성인입니다." : "미성년자입니다.";
//        System.out.println(adult);

        // 문자열 결합 연산자
        System.out.println("Java JDK " + 11.04 + 12); //처음 만나는 데이터 타입이 문자열이면 후 값들이 문자열로 간주됨
